  ...
  return (
    <View style={styles.container}>
      ...
      <Button title="Salvar" onPress={async ()=>{
        ...
        try { 
          await axios.post("https://tdspi-626fa-default-rtdb.firebaseio.com/contato.json",
            obj )
      ...
      <Button title="Carregar" onPress={async ()=>{
        try { 
          const response : AxiosResponse<any, any> = await axios.get(
            "https://tdspi-626fa-default-rtdb.firebaseio.com/contato.json"
          );
        ...
        return (
          <View style={{margin: 20}}>
              ...
              <Button title="Del" onPress={async ()=>{
                  ...
                  try { 
                    await axios.delete(
                    `https://tdspi-626fa-default-rtdb.firebaseio.com/contato/${itemProps.item.id}.json`)
